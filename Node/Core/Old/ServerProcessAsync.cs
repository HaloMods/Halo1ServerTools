...
namespace Hive.Node.Core.Old
{
  ...
  public class ServerProcess : IDisposable
  {
    ...
    /// <summary>
    /// Used to start the process asynchronously.
    /// </summary>
    private delegate bool StartProcessAsync();
    ...
    /// <summary>
    /// Attempts to start the server process.
    /// </summary>
    /// <returns>Boolean indicating if the process was started successfully.</returns>
    private bool PerformStartProcess()
    {
      try
      {
